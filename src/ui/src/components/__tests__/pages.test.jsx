...
describe('Page components', () => {
  ...
  it('renders the Wave 1 welcome page and handles navigation', async () => {
    const user = userEvent.setup()
    const onHome = vi.fn()
  ...
  it('renders welcome sections without extra placeholder copy', () => {
    render(<WelcomeToLifePage onHome={vi.fn()} />)
    ...
    expect(screen.getByText(/The best way to predict your future/)).toBeInTheDocument()
