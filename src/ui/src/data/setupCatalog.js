...
export const EDUCATION_TRACK_CATALOG = [
  {
    id: 'degree-track',
    label: 'Degree Track',
...
export const SETUP_CATALOG = Object.freeze({
  cities: CITY_CATALOG,
...
export const CITY_BY_ID = indexById(CITY_CATALOG)
export const EDUCATION_TRACK_BY_ID = indexById(EDUCATION_TRACK_CATALOG)
export const JOB_BY_ID = indexById(JOB_CATALOG)

export const getCityById = (cityId) => CITY_BY_ID[cityId] || null

export const getEducationTrackById = (trackId) => EDUCATION_TRACK_BY_ID[trackId] || null

export const getJobById = (jobId) => JOB_BY_ID[jobId] || null

export const getJobsByTrackId = (trackId) => JOB_CATALOG.filter((job) => job.trackId === trackId)
