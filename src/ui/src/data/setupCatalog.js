...
export const educationTrackById = Object.fromEntries(educationTracks.map((track) => [track.id, track]))
export const jobById = Object.fromEntries(jobs.map((job) => [job.id, job]))
